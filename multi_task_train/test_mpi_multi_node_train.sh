...
mpirun -n 8 -machinefile $PJM_O_NODEINF -report-bindings -map-by ppr:2:socket singularity exec --nv /home/w49009a/pytorch_omote.sif bash /home/w49009a/omote/KLab_MultiModalModel/multi_task_train/test_each_node_task_train.sh
