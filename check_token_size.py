...
parser.add_argument("target_dataset_name", type=str, choices=['redcaps', 'imagenet', 'imagenet21k', 'places365', 'inaturalist', 'cc3m', 'cc12m', 'sun397', 'mscoco', 'vcr', 'vqa2', 'imSitu', 'tdiuc', 'visual7w_vqa', 'visual7w_gvqa', 'imagenet', 'openimage_cat', 'openimage_det', 'openimage_loc', 'openimage_rel', 'objects365_cat', 'objects365_det', 'objects365_loc'])
