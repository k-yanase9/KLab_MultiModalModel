...
def parse_arguments():
    ...
    parser.add_argument('--datasets', nargs='+', default=['imagenet', 'sun397'], choices=['redcaps', 'imagenet', 'imagenet21k', 'places365', 'inaturalist', 'cc3m', 'cc12m', 'sun397', 'mscoco', 'vcr', 'vqa2', 'imSitu', 'tdiuc', 'visual7w', 'imagenet', 'openimage_cat', 'openimage_det'], help='使用データセットの名前')
    # Dir setting
