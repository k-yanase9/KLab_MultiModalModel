...
def parse_arguments():
    ...
    parser.add_argument('--datasets', nargs='+', default=['imagenet', 'sun397'], choices=['redcaps', 'imagenet', 'imagenet_21k', 'places365', 'inaturalist', 'cc3m', 'sun397', 'mscoco', 'vcr', 'vqa2', 'imsitu', 'imagenet'], help='使用データセットの名前')
    # Dir setting
